...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    courses: Attribute.Relation<
      ...
      'api::course.course'
    >;
    trailer: Attribute.Media & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::category.category',
...
export interface ApiCourseCourse extends Schema.CollectionType {
  ...
  attributes: {
    ...
    featuredImage1: Attribute.Media;
    durationMilisecond: Attribute.BigInteger & Attribute.Required;
    featuredImage2: Attribute.Media;
    learning_objectives: Attribute.Component<
      'lo-points.learning-objectives',
      true
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    orderItems: Attribute.Component<'product.products', true> &
      Attribute.Required;
    amount: Attribute.Decimal;
    moreDetails: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::order.order',
...
export interface ApiPackagePackage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    packageType: Attribute.Enumeration<['yearly', 'monthly']> &
      Attribute.Required &
      Attribute.DefaultTo<'yearly'>;
    packagePoints: Attribute.Component<'points.package-points', true>;
    productLine: Attribute.Relation<
      'api::package.package',
      'manyToOne',
      'api::product-line.product-line'
    >;
    numberOfStudents: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 1;
      }>;
    perStudentMonthlyPrice: Attribute.Integer &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 1;
      }>;
